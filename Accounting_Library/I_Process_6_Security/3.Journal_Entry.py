...
from dr_cr_rule import Asset_Expense_Rule
from dr_cr_rule import Liability_Capital_Revenue_Rule
...
class JournalEntryProcessor:
    def __init__(self, df, main_df):
        ...
        self.liability_capital_revenue = Liability_Capital_Expense_Rule()
    ...
    def process_entries(self,k):
        for i in range(len(self.df)):
            ...
            def To_Entry():
                ...
                k['J8 - Closing Balance'].append(dr)
                k['J5 - Opening Balance'].append(0)
            ...
            def To_purchase():
                ...
                k['J8 - Closing Balance'].append(cr)
                k['J5 - Opening Balance'].append(0)
                k['J9 - Description/Narration'].append('purchase')
                k['J3 - Invoice_Ref_Number'].append(invoice_number)
